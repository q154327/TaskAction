...
if ($.isNode()) {
  ...
  if (process.env.RLBODY && process.env.RLBODY.indexOf('#') > -1) {
   ...
   rlbody = process.env.RLBODY.split()
	...
	console.log(rlurl,rlheader,rlbody)	

	rlurlArr.push($.getdata('rlurl'))
	rlheaderArr.push($.getdata('rlheader'))
	rlbodyArr.push($.getdata('rlbody'))
	
	console.log(rlurlArr,rlheaderArr,rlbodyArr)	
	
  	//rlurlArr.push('access_token=f2e1d57418bb3d6a0439b494f3468a75&client=1&member_id=199053&user_token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..GEvgkDucxuLeGcgDBstPwP6IzcMBx8ScIo17AOTfec0&video_id=29473')
